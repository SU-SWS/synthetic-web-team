...
| Role skills | 0 of 8 built, 0 of 11 stubs |
| `sws` CLI and install wizard | Not started |
...
| [`skills/`](skills/) | The team. Each skill is one `SKILL.md` with two frontmatter keys |
